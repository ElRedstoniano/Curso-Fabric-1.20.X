...
public class ReturnHomeCommand {
    ...
    public static int run(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        if(homepos.length != 0){
            ...
            context.getSource().sendFeedback(() -> Text.translatable("commands.mccourse.home_return_sucess"), false);
            return 1;
        } else {
            context.getSource().sendFeedback(() -> Text.translatable("commands.mccourse.no_home_return"), false);
            return  -1;
        }
    }
}
